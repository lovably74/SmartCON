...
**작성자:** 경영기획실 이대영 이사  
**기반 문서:** `docs/SmartCON_Lite_UI_Design_Guide.md` (v3.4), `docs/PRD.md` (v2.5), `docs/System-Architecture.md`
...
- **PC Web (사이드바)**
  - **HQ**: `/hq/dashboard`, `/hq/sites`, `/hq/workers`, `/hq/contracts`, `/hq/settlements`, `/hq/settings`
  - **Site**: `/site/dashboard`, `/site/attendance`, `/site/reports`, `/site/contracts`, `/site/teams`, `/site/salary`
  - **Worker**: `/worker/dashboard`, `/worker/attendance`, `/worker/contracts`, `/worker/profile`
- **Mobile Web (하단 탭 4개)**
  - 홈(대시보드) / 출역 / 계약 / 내정보
...
**작성자**: 경영기획실 이대영 이사  
**참고**: 본 가이드는 SmartCON_Lite_UI_Design_Guide v3.4 및 PRD v2.5를 기반으로 작성되었습니다.
