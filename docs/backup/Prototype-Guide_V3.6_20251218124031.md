...
**작성자:** 경영기획실 이대영 이사  
**기반 문서:** `docs/SmartCON_Lite_UI_Design_Guide.md` (v3.6), `docs/PRD.md` (v2.7), `docs/System-Architecture.md`
...
**작성자**: 경영기획실 이대영 이사  
**참고**: 본 가이드는 SmartCON_Lite_UI_Design_Guide v3.6 및 PRD v2.7를 기반으로 작성되었습니다.
