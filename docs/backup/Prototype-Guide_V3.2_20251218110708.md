...
**작성자:** 경영기획실 이대영 이사  
**기반 문서:** `docs/SmartCON_Lite_UI_Design_Guide.md` (v3.1), `docs/PRD.md` (v2.3), `docs/System-Architecture.md`
...
**작성자**: 경영기획실 이대영 이사  
**참고**: 본 가이드는 SmartCON_Lite_UI_Design_Guide v3.2 및 PRD v2.3를 기반으로 작성되었습니다.
