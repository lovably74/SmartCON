...
**⚠️ 본 문서는 초급 개발자 1명이 Cursor AI와 함께 단독으로 개발하는 상황에 맞춰 작성되었습니다.**
...
#### Cursor 바이브코딩 세션
- [ ] Cursor에서 백엔드 프로젝트 열기
- [ ] Cursor Chat에 작업 목표 전달
- [ ] 프로젝트 컨텍스트 설정 (Spring Boot, MSSQL 등)
- [ ] 작업 범위 및 요구사항 확인
...
- [ ] `GET /api/auth/roles` (사용자 보유 역할 목록 조회)
- [ ] `POST /api/auth/role-select` (역할 선택)
...
#### 바이브코딩 세션
- [ ] 페어 구성 (Driver + Navigator)
- [ ] VS Code Live Share 세션 시작
- [ ] Discord 음성 채널 입장
- [ ] 작업 목표 및 범위 확인
...
- [ ] 소셜 로그인 버튼 (카카오/네이버)
- [ ] 역할 선택 페이지 (다중 역할 지원)
- [ ] 역할 전환 UI (상단 헤더 또는 프로필 메뉴)

#### 상태 관리
- [ ] `auth.store.ts` (인증 상태)
- [ ] `user.store.ts` (사용자 정보, 다중 역할 포함)
- [ ] `role.store.ts` (현재 선택된 역할)
...
#### Cursor 바이브코딩 세션
- [ ] Cursor에서 백엔드 프로젝트 열기
- [ ] Cursor Chat에 작업 목표 전달 (출역 체크, 대시보드 API)
- [ ] Face API 연동 요구사항 전달
- [ ] 작업 범위 및 요구사항 확인
...
#### Cursor 바이브코딩 세션
- [ ] Cursor에서 프론트엔드 프로젝트 열기
- [ ] Cursor Chat에 작업 목표 전달 (출역 체크 화면, 대시보드)
- [ ] 카메라 접근 및 안면인식 UI 요구사항 전달
- [ ] 작업 범위 및 요구사항 확인
...
#### Cursor 바이브코딩 세션
- [ ] Cursor에서 백엔드 프로젝트 열기
- [ ] Cursor Chat에 작업 목표 전달 (작업일보, 마이페이지 API)
- [ ] 파일 업로드 요구사항 전달
- [ ] 작업 범위 및 요구사항 확인
...
#### Cursor 바이브코딩 세션
- [ ] Cursor에서 프론트엔드 프로젝트 열기
- [ ] Cursor Chat에 작업 목표 전달 (작업일보 작성, 마이페이지)
- [ ] 이미지 업로드 및 달력 UI 요구사항 전달
- [ ] 작업 범위 및 요구사항 확인
...
### 코드 품질
- [ ] Cursor 바이브코딩으로 개발 완료
- [ ] Cursor 코드 리뷰 완료 (Chat을 통한 리뷰)
- [ ] 생성된 코드 이해 및 학습 완료
- [ ] 코딩 컨벤션 준수
- [ ] 주석 작성 (복잡한 로직)
- [ ] 에러 처리 구현
...
| 1.1 | 2025-12-13 | 바이브코딩 체크리스트 추가, 다중 역할 지원 반영 | Gemini |
| 1.2 | 2025-12-13 | Cursor 활용 단독 바이브코딩 체크리스트로 변경 | Gemini |
