...
**작성자:** 경영기획실 이대영 이사  
**기반 문서:** `docs/SmartCON_Lite_UI_Design_Guide.md` (v3.8), `docs/PRD.md` (v2.8), `docs/System-Architecture.md`  
**참고 화면:** 실제 SmartCON 운영 화면 (근로자 관리, 출역 관리, 인트로 페이지)  
**로고 이미지:** `docs/logo_main_white.png` (흰색 로고, 프로토타입 `/public/logo_main_white.png`에 복사)  
**최적화:** PC웹(max-width: 1400px) / 모바일(전체 너비) 각각 최적화, 플랫 디자인(링크 형태) 적용
...
- **눈이 편안한 배경/표면**: 큰 면적 배경은 중립색(예: `#F8FAFC`)으로 통일하고, **Primary 색상(Dark Navy #0F172A)은 헤더/사이드바에, Secondary 색상(Teal Green #10B981)은 CTA/활성/강조 포인트로 사용**합니다.
...
@layer base {
  :root {
    /* SmartCON Lite UI 디자인 가이드 색상 시스템 */
    /* Primary: Dark Navy #0F172A */
    --primary: 220 40 10; /* Dark Navy #0F172A */
    --primary-foreground: 0 0% 100%;

    /* Secondary: Teal Green #10B981 */
    --secondary: 160 84 39; /* Teal Green #10B981 */
    --secondary-foreground: 0 0% 100%;

    /* Accent: Sky Blue #0EA5E9 */
    --accent: 199 89 48; /* Sky Blue #0EA5E9 */
    --accent-foreground: 0 0% 100%;

    /* Background: Light Gray #F8FAFC */
    --background: 210 40 98%; /* Light Gray #F8FAFC */
    --foreground: 220 13 18%; /* Slate-800 #1E293B */
    ...
    /* Border 및 Input */
    --border: 214 32 91%; /* Gray-300 #D1D5DB */
    --input: 214 32 91%;
    --ring: 199 89 48%; /* Sky Blue #0EA5E9 */

    /* Sidebar (Dark Navy) */
    --sidebar: 220 40 10%; /* Dark Navy #0F172A */
...
**SmartCON Lite UI 디자인 가이드에 따른 색상 팔레트입니다.**
...
- **Destructive (Red)**: `#EF4444` - 오류, 삭제, 위험 상태 (결근, 계약 만료 등)
...
```tsx
// Primary 버튼 (Teal Green)
<Button className="bg-[#10B981] text-white hover:bg-[#059669] hover:shadow-md active:scale-95">
  저장
</Button>
...
// Destructive 버튼
<Button variant="destructive" className="bg-[#EF4444] hover:bg-[#DC2626] hover:shadow-md active:scale-95">
  삭제
</Button>
```
...
- **Focus**: `focus:outline-none focus:ring-2 focus:ring-[#0EA5E9] focus:ring-offset-2`
- **Disabled**: `disabled:opacity-50 disabled:cursor-not-allowed`

### 7.6. 링크 스타일

```tsx
// Primary Link (Sky Blue)
<a href="#" className="text-[#0EA5E9] hover:text-[#0284C7] hover:underline underline-offset-4">
  자세히 보기
</a>
...
```tsx
// 포커스 링 (Sky Blue)
className="focus:outline-none focus:ring-2 focus:ring-[#0EA5E9] focus:ring-offset-2"

// 포커스 테두리
className="focus:outline-none focus:border-[#0EA5E9] focus:ring-2 focus:ring-[#0EA5E9] focus:ring-offset-2"
```
...
- [ ] 색상 팔레트 준수 (Dark Navy #0F172A, Teal Green #10B981, Sky Blue #0EA5E9, Light Gray #F8FAFC 등)
...
**작성자**: 경영기획실 이대영 이사  
**참고**: 본 가이드는 SmartCON_Lite_UI_Design_Guide v3.8 및 PRD v2.8를 기반으로 작성되었으며, 실제 SmartCON 운영 화면 구조를 반영하였습니다. PC웹/모바일 각각 최적화되었습니다.
