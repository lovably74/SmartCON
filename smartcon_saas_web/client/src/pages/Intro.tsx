          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative rounded-xl border bg-background shadow-2xl p-2 lg:p-4 rotate-1 hover:rotate-0 transition-transform duration-500">
              <div className="rounded-lg bg-muted/50 aspect-[16/10] flex items-center justify-center overflow-hidden relative">
                ...
                {/* Floating Badge */}
                <div className="absolute bottom-8 right-8 bg-white p-4 rounded-lg shadow-lg border animate-bounce-slow">
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-3 text-sm mb-6">
                  <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-primary" /> 현장 1개 관리</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-primary" /> 관리자 2명</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-primary" /> 출역 관리 기본</li>
                </ul>
            ...
            <Card className="border-primary shadow-xl relative overflow-hidden">
              ...
              <CardContent>
                <ul className="space-y-3 text-sm mb-6">
                  <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-primary" /> 현장 5개 관리</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-primary" /> 관리자 10명</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-primary" /> 안면인식 연동</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-primary" /> 전자근로계약 무제한</li>
                </ul>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-3 text-sm mb-6">
                  <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-primary" /> 현장 무제한</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-primary" /> 관리자 무제한</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-primary" /> ERP 연동 지원</li>
                  <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-primary" /> 전담 기술 지원</li>
                </ul>
